...
SWEEP_PARAMETER = "k_d_ds"   # used for axis labels and output filenames

PARAMETER_VALUES = np.array([0.2,0.25,(1/3),0.5,1]) * 3e-4
...
CSV_FILENAME_TEMPLATE = "timeseries_k_d_ds={value}_rep=0_5mmx5mm.csv"
